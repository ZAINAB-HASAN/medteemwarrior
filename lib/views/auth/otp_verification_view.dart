...
import 'package:med_teem_app/core/custom_widgets/custom_input/otp_field.dart';
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [AppColors.appColor.withOpacity(0.05), AppColors.appColor.withOpacity(0.1)],
              ),
            ),
          ),
          Positioned(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 30),
                          OtpField(length: 6, controller: controller.otpController),
                          SizedBox(height: 30),
                          Obx(() => RoundButton(
                                title: 'Verify OTP',
